...
namespace advent.solvers
{
    public class Day04Solver : Solver
    {
        ...
        private readonly DataProvider<Guard> dataProvider;

        public Day04Solver(DataProvider<Guard> dataProvider)
        {
        ...
        public string SolveSecondPart()
        {
            ...
            var mostAsleepGuard = minutesMostAsleepByGuard.OrderByDescending(gm => gm.MinuteMostAsleepAndTimes.times).First();
